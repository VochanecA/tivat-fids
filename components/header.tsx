...
import {
  RefreshCw, Maximize, Menu, X, Info, Download,
  BatteryCharging, Battery, HelpCircle
} from 'lucide-react';
...
export function Header() {
  ...
  // Mounted state for hydration-safe theme label
  ...
  // Hydration-safe theme label for mobile menu
