...
const thClassNames = 'px-4 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300';
const thNarrowClassNames = 'px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400';
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead className="bg-gray-50 dark:bg-gray-800">
            <tr>
              ...
              <th scope="col" className={thNarrowClassNames}>
                Terminal
              </th>
            ...
            {loading ? (
              Array.from({ length: 5 }).map((_, index) => (
                <tr key={index} className="animate-pulse">
                  {Array.from({ 
                    length: activeTab === 'departures' ? 8 : 7
                  }).map((__, colIndex) => (
                    <td key={colIndex} className={colIndex === 4 ? 'px-2 py-4' : 'px-4 py-4'}>
